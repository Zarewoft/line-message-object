...
describe("TextMessage", () => {
  it("should construct type property 'text'", () => {
    const textMessage = TextMessage.New("text message");
    assert.equal(textMessage.message.getJSON().type, "text");
  });

  it("should construct text message 1", () => {
    const textMessage = TextMessage.New("hello world");
    assert.deepEqual(textMessage.message.getJSON(), {
      type: "text",
      text: "hello world"
    });
  });

  it("should construct text message 2", () => {
    const textMessage = TextMessage.New("line message");
    assert.deepEqual(textMessage.message.getJSON(), {
      type: "text",
      text: "line message"
    });
